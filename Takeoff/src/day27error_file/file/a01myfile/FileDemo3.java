...
public class FileDemo3 {
    public static void main(String[] args) {
     /*
        ...
        public String getName()             返回文件的名称，带后缀a.txt   或 文件夹的名字   这个很重要 ***
     ...
     */
        ...
        File f3 = new File("E:\\flanlin\\picture");
        String path1 = f3.getAbsolutePath();
        System.out.println(path1);

        File f4 = new File("Takeoff\\src\\day27error_file\\file\\a01myfile\\FileDemo3.java");
        ...
        String name1 = f7.getName();        //a.txt   得到文件名
        System.out.println(name1);


        File f8 = new File("D:\\aaa\\bbb");
        String name2 = f8.getName();        //得到文件夹名
