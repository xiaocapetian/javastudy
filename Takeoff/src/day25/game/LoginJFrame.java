...
import day25.domain.User;
import day25.util.CodeUtil;
...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    public void initView() {
        ...
        login.setIcon(new ImageIcon("Takeoff\\src\\day25\\image\\login\\登录按钮.png"));
        //去除按钮的边框
        ...
        register.setIcon(new ImageIcon("Takeoff\\src\\day25\\image\\login\\注册按钮.png"));
        //去除按钮的边框
        ...
        //7.添加背景图片
        JLabel background = new JLabel(new ImageIcon("Takeoff\\src\\day25\\image\\login\\background.png"));
